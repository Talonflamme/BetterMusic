...
const MainContentTabLink: React.FC<MainContentTabLinkProps> = ({ className, children, id, setCurrentTab }) => {
    ...
    return <span className={`tab-link ${className}`} data-tab={id} onClick={onClick}>
        {children}
    </span>
}
        ...
        <div id="content">
            <header id="main-tabs" className="flex-center">
                ...
                <span className="flex-center">
                    <a className="tab-link icon" href="https://www.github.com/Talonflamme" target="_blank" rel="noreferer" tabIndex={-1}>
